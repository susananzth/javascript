...
function DataJS() {
  return (
    <Content 
        ...
        <p>Un dato es un valor que puede ser procesado por un programa. Ejemplos incluyen números, texto y booleanos.</p>
        ...
        <p>Una variable es un contenedor que almacena datos. Puedes cambiar el valor de una variable y usarlo en tu programa.</p>
